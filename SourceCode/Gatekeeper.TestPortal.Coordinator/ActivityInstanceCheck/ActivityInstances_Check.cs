...
{
    public class ActivityInstances_Check:IClassFixture<CoordinatorActivityCodeAuthFixture>
    {
        private IDriverManager _driverManager;
        public ActivityInstances_Check(CoordinatorActivityCodeAuthFixture Fixture)
        {
